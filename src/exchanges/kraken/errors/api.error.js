 ...
 */
//TODO: Fill the codes
class KrakenApiException extends ExchangeBaseException {
    ...
    constructor(err, body) {
        ...
        if (KrakenApiException.codesMap.has(oErrCode)) {
            this.code = KrakenApiException.codesMap.get(oErrCode);
        } else {
...
module.exports = KrakenApiException;
