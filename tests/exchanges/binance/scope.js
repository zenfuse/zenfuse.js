...
module.exports = (env) => ({
    ...
    'exchange.ping()': () => nock(HOSTNAME).get('/api/v3/ping').reply(200, {}),
    ...
    'order values precision': () =>
        nock(HOSTNAME)
            ...
            .reply(201, {
                symbol: toBinanceStyle(env.PRECISION_REQUIRED_ORDER.symbol),
                orderId: 5114608,
                orderListId: -1,
                clientOrderId: 'nVuwTgVfxQtsMV9uuMMXxL',
                transactTime: Date.now(),
        ...
        nock(HOSTNAME)
            ...
            .query((q) => {
                expect(q).toMatchObject({
                    ...
                    quantity: toBinanceStyle(env.NOT_EXECUTABLE_ORDER.quantity),
                });
